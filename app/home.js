...
//                       <div style={{ flex: 1 }}>
//                         <Image src={index % 3 === 0 ? myimg1 : index % 3 === 1 ? myimg2 : myimg3} style={{ width: "80%", height: "70%" }} alt="Card image" fluid />
//                       </div>
//                       <div style={{ flex: 1 }}>
...
//               {[...Array(9)].map((_, index) => (
//                 <div key={index}>
//                   <Card style={{ backgroundColor: '#001f3f', color: '#ffffff', border: '1px solid rgba(255, 255, 255, 0.3)', margin: '0 10px' }}> {/* Adjust margin here */}
//                     <Card.Body className="d-flex align-items-center justify-content-between">
//                       <div style={{ flex: 1 }}>
//                         <Image src={index % 3 === 0 ? myimg1 : index % 3 === 1 ? myimg2 : myimg3} style={{ width: "80%", height: "70%" }} alt="Card image" fluid />
//                       </div>
